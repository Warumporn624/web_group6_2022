...
<div class="row">
      <div class="col-md-5 col-lg-5 rounded-3 p-5">
      <img src="component/image/student.jpg" class="img-fluid" alt="coverStudent">
      </div>

<div class="col-md-7 col-lg-7 text-white rounded-3 p-5">
...
<div class="d-flex align-items-center mb-3 mb-lg-0 me-lg-auto text-dark text-decoration-none"></div>
<form class="col-12 col-lg-auto mb-3 mb-lg-0">
    <input type="search" class="form-control" id="myInput2" placeholder="ค้นหานักเรียน..." aria-label="Search">
</form>
</div>
